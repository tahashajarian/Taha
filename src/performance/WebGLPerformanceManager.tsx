...
export default function WebGLPerformanceManager({ lowPerformance }: { lowPerformance: boolean }) {
  ...
  useEffect(() => {
    if (lowPerformance) {
      console.log('performance => WebGLPerformanceManager: Low performance detected, reducing quality...')
      handleFocus()
