...
export function Chess({ moveDuration = 600, ...props }) {
  ...
  useEffect(() => {
    if (queenBRef.current) {
      queenBRef.current.scale.set(1.02, 1.02, 1.02);
    }
  }, []);
  ...
  return (
    <group
      ...
      dispose={null}
    >
      <a.mesh ref={queenRef} geometry={nodes.queen.geometry} material={materials.WHITE} position={queenSpring.position} />
      <a.mesh ref={knightRef} geometry={nodes.knight.geometry} material={materials.WHITE} position={knightSpring.position} />

      {[
        "Alfil_Circle011","Peon_Circle005","Rey_Circle007","Torre_Circle010",
        "Caballo_Circle001","Alfil_Circle001","Torre_Circle001",
      ...
      <a.mesh ref={pawnRef} geometry={nodes.pawn.geometry} material={materials.BLACK} position={pawnSpring.position} />
      <a.mesh ref={queenBRef} geometry={nodes.queenB.geometry} material={materials.BLACK} position={queenBSpring.position} />

      {[
        "Alfil_Circle002","Caballo_Circle002","Rey_Circle001","Torre_Circle002",
        "Caballo_Circle003","Alfil_Circle003","Torre_Circle003",
